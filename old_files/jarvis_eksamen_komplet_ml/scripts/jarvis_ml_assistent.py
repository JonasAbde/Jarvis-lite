...
def main_loop():
    ...
    if not speak_gtts("Hej, jeg er Jarvis Lite med Machine Learning. Hvad kan jeg hjælpe med?"):
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("Denne version bruger Machine Learning til at forstå kommandoer")
    print("Eksempler på kommandoer:")
    print("  - 'Hvad er klokken?' / 'Fortæl mig tiden'")
    print("  - 'Åbn YouTube' / 'Jeg vil se YouTube'")
    print("  - 'Skriv en note' / 'Gem dette'")
    print("  - 'Hvem er du?' / 'Fortæl om dig selv'")
    print("  - 'Farvel' / 'Slut' (for at afslutte)")
    print("=" * 50)
